            ...
            <Card.Body>
                <div className="w-full flex mb-2 bg-black rounded-lg px-4 py-2">
                    ...
                    <div className="w-4/5">
                        ...
                        <Image unoptimized src="/m3.jpg" alt="ICT Fest 2024 By IUT CSE" width={500} height={300} className="m-4 px-4 py-2 border border-white rounded-lg"/>
                    </div>
                </div>
                <div className="w-full flex  mb-2 bg-black rounded-lg px-4 py-2">
                    <div className="w-1/5 ms-4 me-4">
                    ...
                    <div className="w-4/5">
                        ...
                        <Image unoptimized src="/devsprint.jpg" alt="ICT Fest 2024 By IUT CSE" width={500} height={300} className="m-4 px-4 py-2 border border-white rounded-lg"/>
                    </div>
                </div>
                <div className="w-full flex  mb-2 bg-black rounded-lg px-4 py-2">
                    <div className="w-1/5 ms-4 me-4">
                    ...
                    <div className="w-4/5">
                        ...
                        <Image unoptimized src="/buetcsefest.jpg" alt="ICT Fest 2024 By IUT CSE" width={500} height={300} className="m-4 px-4 py-2 border border-white rounded-lg"/>
                    </div>
                </div>
            </Card.Body>
        </Card>
