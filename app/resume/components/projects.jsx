    ...
    return (<Card className="w-full bg-zinc-950 px-4 py-2 rounded-lg mb-5">
        ...
        <div className="projects">
            ...
            <div className="subrubric">
                <Link href="https://github.com/azwadmirza"><h1 className="text-xl mb-2 hover:text-black hover:bg-white px-4 py-2 rounded-lg">Academic Projects <IonIcon icon={logoGithub}></IonIcon></h1></Link>
            ...
            <div className="subrubric">
            <Link href="https://github.com/mirzaazwad"><h1 className="text-xl mb-2 hover:text-black hover:bg-white px-4 py-2 rounded-lg">Personal and Professional Projects <IonIcon icon={logoGithub}></IonIcon></h1></Link>
                <div className="flex flex-col mb-2 px-4 py-2 rounded-lg bg-black">
